...
import 'package:flutter_login_demo/pages/adoption_forms.dart';
import 'dart:async';
        ...
        child: ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(
              accountName: new Text('Aniket Raj'),
              accountEmail: new Text('aniketraj3160@gmail.com'),
              currentAccountPicture: new CircleAvatar(
                backgroundImage: new NetworkImage('http://i.pravatar.cc/396'),
              ),
            ),
            ...
            Container(
              ...
              child: new ListTile(
                ...
                title: new Text('Adopt a pet :)',style: TextStyle(color: Colors.teal)),
                onTap: () {
                  Navigator.of(context).pop();
                  Navigator.push(
                      context,
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                 ...
                 children: <Widget>[
                   Text("aniketraj3160@gmail.com",style: TextStyle(
                     color:Colors.white,
                     fontSize: 14.0,
                     fontWeight: FontWeight.bold,
